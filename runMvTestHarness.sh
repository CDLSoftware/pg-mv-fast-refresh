...
echo "Enter the PostGre HostName: [$DefaultHostname]"

read pgHostName

echo
echo "Enter the PostGre Port: [$DefaultPort]"

read pgPort

echo
echo "Enter the PostGre SuperUser name: [$DefaultSuperUser]"

read pgSuperUser

echo
echo "Enter the PostGre Database name: [$DefaultDatabase]"
